...
export default function HumidityAreaChart() {
  ...
  const fetchData = async () => {
    try {
      ...
      const swData = await axios.get('http://localhost:5102/api/MonitoringStation/humidity');
      ...
      const humidity = combinedData.map(data => data.humidity);
