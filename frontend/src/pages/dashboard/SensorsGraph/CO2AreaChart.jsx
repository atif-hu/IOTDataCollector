...
export default function CO2AreaChart() {
  ...
  const fetchData = async () => {
    try {
      ...
      const swData = await axios.get('http://localhost:5102/api/MonitoringStation/co2emissions');
      ...
      const airpollution = combinedData.map(data => data.cO2?data.cO2:data.cO2Emissions);
