    ...
    const fetchData = async () => {
      try {
        ...
        const transformedData = data.map((item) => ({
          ...
          airpollution: item.airPollution,
        ...
        //south west response
        const swResponse = await axios.get('http://localhost:5102/api/MonitoringStation/airpollution');
            ...
            {stableSort(rows, getComparator(order, orderBy)).map((row, index) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell align="right">{row.airpollution}</TableCell>
