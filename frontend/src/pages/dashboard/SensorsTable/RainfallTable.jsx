  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        //South West data
        const southWestResponse = await axios.get('http://localhost:5102/api/MonitoringStation/rainfall');
        const sWdata = southWestResponse.data;

        // Transform  swData to match the table format
